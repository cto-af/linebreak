...
export const generatedDate = new Date("2024-03-07T04:49:31.912Z");
export const EastAsianWidth = UnicodeTrie.fromBase64(
  `AAAEAAAAAAD/////tQIAAB+LCABbR+llAgPtmj9IHzEUx8+fbam1FLoUCh1aaCl0cSoODgou
   ...
   pJTR4EkAAB+LCABbR+llAgOLVvJT0lGKVIoFANHfAiwJAAAA`
);
